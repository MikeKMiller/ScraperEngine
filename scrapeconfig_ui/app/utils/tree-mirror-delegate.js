...
function addEmbedBlockedMessage(node) {
    ...
    var errorMsg = $("<div/>").css({
        ...
        'height': height,
        'lineHeight': height,
    }).text("ScrapeConfig doesn't support browser plugins.");
