...
class BaseLinkExtractor(object):
    ...
    def normalize_link(self, link):
        ...
        >>> l = Link('http://blue360media.com/some/path/../dir')
        >>> le.normalize_link(l).url
        'http://blue360media.com/some/dir'
        >>> l = Link('http://blue360media.com/some//./path/')
        >>> le.normalize_link(l).url
        'http://blue360media.com/some/path/'
        ...
        True
        >>> le.normalize_link(Link('http://blue360media.com')).url
        ...
        'something'
        >>> le.normalize_link(Link('http://blue360media.com#some fragment')).url
        'http://blue360media.com/'
