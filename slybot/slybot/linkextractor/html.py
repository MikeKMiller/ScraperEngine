...
def iterlinks(htmlpage):
    ...
    >>> p = HtmlPage(body=u"Please visit <a href='http://blue360media.com/'>Blue360Media</a>")
    >>> next(iterlinks(p))
    Link(url='http://blue360media.com/', text=u'Blue360Media', fragment='', nofollow=False)
    ...
    >>> p.url = 'http://blue360media.com/'
    >>> next(iterlinks(p))
    Link(url='http://blue360media.com/home.html', text=u'Home', fragment='', nofollow=False)
    ...
    >>> next(iterlinks(p))
    Link(url='http://blue360media.com/myproject/index.html', text=u'project', fragment='', nofollow=False)
