...
class ScrapeConfigCookieJar(SplashCookieJar):
    ...
    def setCookiesFromUrl(self, cookie_list, url):
        result = super(ScrapeConfigCookieJar, self).setCookiesFromUrl(cookie_list, url)
        self.update_client_cookies()
        return result

    def setAllCookies(self, cookie_list):
        result = super(ScrapeConfigCookieJar, self).setAllCookies(cookie_list)
        self.update_client_cookies()
        return result
    ...
    def put_client_cookies(self, cookie_list):
        ...
        return super(ScrapeConfigCookieJar, self).setAllCookies(qt_cookies)
