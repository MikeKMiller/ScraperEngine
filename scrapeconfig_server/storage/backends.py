...
class BaseScrapeConfigStorage(CommittingStorage, Storage):
...
class FsStorage(BaseScrapeConfigStorage, FileSystemStorage):
...
class GitStorage(BaseScrapeConfigStorage):
