...
COPY scrapeconfig_server/requirements.txt /app/scrapeconfig_server/requirements.txt
...
RUN /app/provision.sh install_deps && \
    ...
    pip install -r /app/scrapeconfig_server/requirements.txt && \
...
RUN python /app/scrapeconfig_server/manage.py makemigrations scrapeconfig_dashboard 
RUN python /app/scrapeconfig_server/manage.py migrate
